...
import static is.citizen.technicaltest.utils.TestConstant.*;
...
public class PersonApiTest {
    ...
    public ResponseEntity<JsonNode> executeFileRequest(String sort, String filter, String group, boolean normalize) {
        ...
        UriComponentsBuilder builder = UriComponentsBuilder
                .fromHttpUrl("http://localhost:8888/api/persons")
        ...
        return restTemplate.exchange(builder.build().encode().toUri(),
                HttpMethod.POST, new HttpEntity<>(PERSON_JSON_CONTENT, headers), JsonNode.class);
    }
}
